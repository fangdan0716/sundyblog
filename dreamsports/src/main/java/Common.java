...
public class Common {
    ...
    public void SwipeLeft(AndroidDriver driver) {
        ...
        new TouchAction(driver)
                ...
                .moveTo(PointOption.point(width-1000, height / 2)).release()
                .perform();
    }
    ...
    public void SwipeRight(AndroidDriver driver) {
        ...
        int height = size.height;
        int width = size.width;
        new TouchAction(driver).longPress(PointOption.point(width-1000, height / 2))
                .moveTo(PointOption.point( 908, height / 2)).release()
                .perform();
    }

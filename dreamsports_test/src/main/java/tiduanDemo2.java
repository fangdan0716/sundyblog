...
//      des.setCapability("browserName", "chrome");  //h5
        ...
        des.setCapability("deviceName", "192.168.168.73:5555");//使用的手机类型或模拟器类型  UDID  192.168.1.193:5555  AFFBB20721901159
        des.setCapability("udid","192.168.168.73:5555");

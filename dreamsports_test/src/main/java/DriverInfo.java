...
public class DriverInfo {
    public static AndroidDriver DriverInfo(String platformName, String platformVersion,
                                           String deviceName, String appPackage, String appActivity) throws InterruptedException, MalformedURLException {

...
public class tableTennisLevelThird {
    public  static final Logger LOGGER= LoggerFactory.getLogger("tableTennisLevelThirdDriver");
    //
    public static AndroidDriver tableTennisLevelThirdDriver() throws InterruptedException, MalformedURLException {
    ...
    public static void tableTennisLevelThirdMotion() throws InterruptedException, MalformedURLException {
        AndroidDriver driver = tableTennisLevelThirdDriver();
    ...
    public static void main(String[] args) throws MalformedURLException, InterruptedException {
        tableTennisLevelThird.tableTennisLevelThirdMotion();
